...
If (recipient = "")
{
    AddChatMessage("{B22222} FEHLER: {FFFFFF} Empf�nger darf nicht leer sein!")
    Return false
}
If recipient is digit 
{
   ...
   {
     AddChatMessage("{B22222} FEHLER: {FFFFFF} Du kannst dir selbst nichts �berweisen.")
  
   }
   If (recipient = "")
{
    AddChatMessage("{B22222} FEHLER: {FFFFFF} Die eingegebene ID ist ungültig")
    Return false
}
...
{
    AddChatMessage("{B22222} FEHLER: {FFFFFF} Betrag ung�ltig")
    Return false
}
if (!CP.LoggedIn)
{

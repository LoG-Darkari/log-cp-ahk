BuildTeamObjects()
{
    ...
    ; Jede Zeile als Objekt hinzuf�gen
    Add(team, "Orangebox",     "Projektleitung - Mapping",          "1338", "Mapverwaltung - Task-Force Vorschl�ge")
    Add(team, "dreamtex",      "Projektmanagement - Mapping",       "1338", "Mapverwaltung -Task-Force Vorschl�ge")
    Add(team, "Luke",          "Projektmanagement",                "1338", "Task-Force Vorschl�ge")
    ...
    Add(team, "hope",          "Administration",                   "2",    "Task-Force Vorschl�ge")
    ...
    Add(team, "Monsta",   "Content Creator",                     "",     "")

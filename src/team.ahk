BuildTeamObjects()
{
    ...
    Add(team, "Artemis",       "Administration",                   "3",    "Eventmanagement - Task-Force Vorschläge")
    ...
    Add(team, "Tobi_Gafas",    "Administration",                   "2",    "Fraktionsverwaltung - Task-Force Vorschläge")
    Add(team, "Airmake",       "Administration",                          "1",     "Task-Force Vorschläge")
